...
<p>1532 words, ~8 minute read. <span v-html="data[`site/${pageData.page.value.relativePath}`]" /></p>
<hr/>
...
Perhaps this could be part of a larger "chat glue" leaf app, where each board is a top level thread.
